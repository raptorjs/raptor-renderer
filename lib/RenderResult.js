...
RenderResult.prototype = {
    ...
    getWidget: function () {
        ...
        var widgetDefs = this._getWidgetDefs();
        if (!widgetDefs) {
    ...
    _getWidgetDefs: function() {
        var widgetsContext = this.context.widgets;
        return widgetsContext ? widgetsContext.widgets : null;
    },
    _afterInsert: function () {
        this._added = true;
        raptorPubsub.publish('raptor-renderer/renderedToDOM', {
            node: this.getNode(),
